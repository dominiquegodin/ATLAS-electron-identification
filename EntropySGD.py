...
class EntropySgd(Optimizer):
    ...
    """
    def __init__(self, lr=.001, sgld_step=0.1, L=20, gamma=0.03, sgld_noise=1e-4, alpha=0.75, scoping=1e-3,
                 momentum=0., nesterov=False, decay=.0, name='SGD', **kwargs):
        super(EntropySgd, self).__init__(name=name, **kwargs)
    #def __init__(self, lr=.001, sgld_step=0.1, L=20, gamma=0.03, sgld_noise=1e-4, alpha=0.75, scoping=1e-3,
    #             momentum=0., nesterov=False, decay=.0, **kwargs):
