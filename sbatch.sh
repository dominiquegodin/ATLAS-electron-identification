...
#SBATCH --time=0-08:00     # time limit (DD-HH:MM)
...
singularity shell --nv --bind /lcg,/opt $SIF classifier.sh $SBATCH_VAR $SCRIPT_VAR
...
#singularity shell --nv --bind /project/def-arguinj/dgodin $SIF < classifier.sh $SBATCH_VAR
