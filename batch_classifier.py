...
from utils     import make_data, make_labels, balance_sample, class_filter, class_matrix
...
test_data    = make_data(data_file, all_var, train_var['images'], n_test, floats16)
...
if floats16: tf.keras.mixed_precision.experimental.set_policy('mixed_float16')
...
if args.n_epochs >= 1:
    ...
    for idx_1, idx_2 in list(zip(n_train[:-1], n_train[1:])):
        ...
        start_time   = time.time()
        train_data   = make_data(data_file, all_var, train_var['images'], [idx_1,idx_2], floats16)
